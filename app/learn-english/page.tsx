        ...
        <CardContent>
          <div className="flex flex-wrap gap-3">
            ...
            <Button asChild variant="outline" className="gap-2">
              <a 
                href="https://github.com/EskandarAtrakchi/Portloaise-webpage-1.0/blob/main/Online%20ESOL%20classes%20and%20resources%20July%202024.pdf" 
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <Button asChild variant="outline" className="gap-2">
              <a 
                href="https://github.com/EskandarAtrakchi/Portloaise-webpage-1.0/blob/main/Arabic%20version.pdf" 
                target="_blank"
                rel="noopener noreferrer"
              >
                <Download className="h-4 w-4" />
